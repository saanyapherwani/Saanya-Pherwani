...
class Product:
    ...
    def make_transaction(self):
        ...
        while paid < price:
            coins= int(input("Please enter how you will pay for the item."))
            if coins==20:
                paid+=20.00
            elif coins==10:
                paid+= 10.00
            ...
            print(f"Amount paid so far: {paid}")
            if enough_answer== 'No':
                print("Thank you for your purchase")
                break
            
        change_due = paid - price
        print("Your change due is $", change_due)
...
while True:
    ...
    requested_color = input('Please enter a color for your item: ')
    found_match = False
    ...
    if buy_more == 'n':
        ...
        print(make_recommendation(inventory, titles, name, category))   
