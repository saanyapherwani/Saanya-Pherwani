...
# layout
    ...
    def build(self):
        ...
        self.button2 = Button(text='Submit Payment', font_size=30, size_hint=(1,.15), halign='center')
        self.button2.bind(on_press=self.Payment_Input_Button)
        Payment_Box.add_widget(self.button2)
        self.button3 = Button(text='Finished Paying', font_size=30, size_hint=(1,.15), halign='center')
        ...
        self.button4 = Button(font_size=30, size_hint=(1,.2), halign='center')
